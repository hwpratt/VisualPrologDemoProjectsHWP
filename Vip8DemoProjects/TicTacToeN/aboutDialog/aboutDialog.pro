...
clauses
    generatedInitialize() :-
        setText("About"),
        setRect(rct(122, 26, 386, 158)),
        setModal(true),
        setDecoration(titlebar([closeButton])),
        setState([wsf_NoClipSiblings]),
        Icon1_ctl = iconControl::new(This),
        Icon1_ctl:setIcon(resourceIdentifiers::ico_ProjectIcon64_whiteBG),
        Icon1_ctl:setPosition(216, 6),
        Icon1_ctl:setSize(32, 32),
        version1_ctl := versioncontrol::new(This),
        version1_ctl:setPosition(16, 22),
        version1_ctl:setSize(176, 16),
        GroupBox_ctl = groupBox::new(This),
        GroupBox_ctl:setText(""),
        GroupBox_ctl:setPosition(8, 44),
